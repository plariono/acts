...
from acts.examples import Sequencer, RootParticleReader
...
def getArgumentParser():
    ...
    parser.add_argument(
        "acts_dir",
        help="ACTS input directory containing both source and build ones.",
    )
    parser.add_argument(
        "-i",
        "--indir",
...
if "__main__" == __name__:
    ...
    actsdir = Path(__file__).resolve().parent.parent.parent.parent.parent
    ...
    runCKFTracks(
        ...
        decorators,
        field=field,
        geometrySelection=actsdir
        / "acts/bin/geoSelection-alice3-cfg9.json",
        digiConfigFile=actsdir
